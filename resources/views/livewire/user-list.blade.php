<div wire:poll.3s.keep-alive.visible class="h-160 flex flex-col items-start justify-start gap-4 lg:w-1/2">
    ...
    <div class="flex w-full flex-col items-start gap-4">
        <div class="w-full grow">
            <button type="button" wire:click='generateRandomUser'
                class="flex gap-3 items-center justify-center w-full cursor-pointer rounded-lg border border-blue-700 px-5 py-2.5 text-center text-sm font-medium text-blue-700 hover:bg-blue-800 hover:text-white focus:outline-none focus:ring-4 focus:ring-blue-300 dark:border-blue-500 dark:text-blue-500 dark:hover:bg-blue-500 dark:hover:text-white dark:focus:ring-blue-800">
                Generate random user
                <div role="status" wire:loading wire:target='generateRandomUser'>
                    <svg aria-hidden="true"
                        class="inline h-5 w-5 animate-spin fill-blue-600 text-blue-200 dark:fill-blue-300 dark:text-blue-600"
        ...
        <form wire:submit="search" class="w-full grow">
            ...
            <div class="relative">
                ...
                <svg wire:loading wire:target="query" aria-hidden="true"
                    class="right-25 absolute top-[50%] h-5 w-5 -translate-y-[50%] animate-spin fill-indigo-800 text-gray-500 dark:text-gray-300"
                    viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z"
                        fill="currentColor" />
