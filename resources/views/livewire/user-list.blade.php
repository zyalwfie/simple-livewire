<div class="flex flex-col items-start justify-start gap-4 grow h-160">
        ...
        <form wire:submit="search" class="grow">
            ...
            <div class="relative">
                ...
                <svg wire:loading wire:target="query" aria-hidden="true"
                    class="w-5 h-5 absolute right-25 top-[50%] -translate-y-[50%] text-gray-500 animate-spin dark:text-gray-300 fill-indigo-800" viewBox="0 0 100 101"
