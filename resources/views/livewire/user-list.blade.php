    ...
    <div class="flex flex-col gap-4 items-start w-full">
        <div class="grow w-full">
            <button type="button" wire:click="generateRandomUser"
                class="px-4 py-2 flex items-center justify-center gap-2 rounded border border-gray-300 bg-gray-300 text-gray-800 transition hover:bg-gray-600 hover:text-gray-200 cursor-pointer w-full">
                <svg wire:loading wire:target="generateRandomUser" aria-hidden="true"
                    class="w-5 h-5 text-gray-500 animate-spin dark:text-gray-300 fill-indigo-800 order-2"
        ...
        <form wire:submit="search" class="grow w-full">
            ...
            <div class="relative">
                ...
                <svg wire:loading wire:target="query" aria-hidden="true"
                    class="w-5 h-5 absolute right-25 top-[50%] -translate-y-[50%] text-gray-500 animate-spin dark:text-gray-300 fill-indigo-800"
                    viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z"
                        fill="currentColor" />
